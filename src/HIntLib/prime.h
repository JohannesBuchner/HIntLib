...
#  include <HIntLib/prime_generated.h>
   ...
   static void factorPrimePower (unsigned n, unsigned &_p, int &_exp);
   ...
   static int factorPrimePowerPower (unsigned n)
   {
      unsigned prime;
      int power;
      factorPrimePower (n, prime, power);
   ...
   static bool isPrimePower (unsigned n, unsigned &_p, int &_exp);
   ...
   typedef std::vector<std::pair<unsigned, int> > Factorization;
...
template<> inline bool HIntLib::Prime::test (int n)
{
   return test (unsigned (abs(n)));
}
template<> inline bool HIntLib::Prime::test (short n)
{
   return test (unsigned (abs(n)));
}
...
template<>
inline
int HIntLib::Prime::searchForNextPrime(int n)
{
   return searchForNextPrime(unsigned(n));
}
